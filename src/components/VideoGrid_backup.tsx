...
{t('videoGrid.leftRepeater')} {t('videoGrid.demoMode')}
          ...
          {fullscreenCamera === 'leftPillar' && (
            videoUrls.left_pillar ? (
              <>
                <video
...
{t('videoGrid.leftPillar')} {t('videoGrid.demoMode')}
              </Box>
            )
          )}
          
          {fullscreenCamera === 'rightPillar' && (
            videoUrls.right_pillar ? (
              <>
                <video
...
{t('videoGrid.rightPillar')} {t('videoGrid.demoMode')}
              </Box>
            )
          )}
        </Box>
...
{t('videoGrid.noVideo')}
          ...
          <Paper 
            style={{
              ...
              position: 'relative',
              overflow: 'hidden',
              cursor: videoUrls.left_pillar ? 'pointer' : 'default',
              transition: 'all 200ms ease',
              borderLeft: '1px solid rgba(255,255,255,0.1)',
              borderRight: '1px solid rgba(255,255,255,0.1)',
              borderTop: '1px solid rgba(255,255,255,0.1)'
            }}
            onMouseEnter={() => videoUrls.left_pillar && setHoveredCamera('leftPillar')}
            onMouseLeave={() => setHoveredCamera(null)}
            onClick={() => videoUrls.left_pillar && toggleFullscreen('leftPillar')}
          >
            {videoUrls.left_pillar ? (
              <>
                <video
...
{t('videoGrid.noVideo')}
          ...
          <Paper 
            style={{
              ...
              position: 'relative',
              overflow: 'hidden',
              cursor: videoUrls.right_pillar ? 'pointer' : 'default',
              transition: 'all 200ms ease',
              borderLeft: '1px solid rgba(255,255,255,0.1)',
              borderTop: '1px solid rgba(255,255,255,0.1)'
            }}
            onMouseEnter={() => videoUrls.right_pillar && setHoveredCamera('rightPillar')}
            onMouseLeave={() => setHoveredCamera(null)}
            onClick={() => videoUrls.right_pillar && toggleFullscreen('rightPillar')}
          >
            {videoUrls.right_pillar ? (
              <>
                <video
